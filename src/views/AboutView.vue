<template>
  <div class="container py-4">
    <div class="about mt-4 py-4">
      <h1 class="display-2">About View</h1>
    <!-- About My Self -->
   <div class="row">
    <div class="col">
      <img style="border-radius: 5%; margin-left:7%; margin-top:5%;" width="300px" src="../assets/aboutme.jpg" alt="me">
    </div>
    <div class="col">
      <p>
